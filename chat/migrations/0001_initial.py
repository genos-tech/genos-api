...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='ChatGroup',
            fields=[
                ('id_chat_group', models.AutoField(primary_key=True, serialize=False)),
                ('st_chat_group_name', models.CharField(max_length=100)),
                ('bl_personal', models.BooleanField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dt_create', models.DateTimeField(auto_now_add=True)),
                ('dt_last_login', models.DateTimeField(auto_now=True, null=True)),
