...
# the time the controller asks for a tool by name. CREATE_TASK is the
# first write tool (requires_approval=True) — see Phase 7.
for _t in (SEARCH_KNOWLEDGE_BASE, FETCH_TASK, FETCH_CHAT_THREAD, FETCH_NOTE, CREATE_TASK):
    REGISTRY[_t.name] = _t
