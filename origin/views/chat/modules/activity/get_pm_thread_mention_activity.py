...
def get(user_id: str, team_id: str, my_all_pm_ids, n_days_ago: datetime):
    ...
    _pm_me_mentioned_thread_messages = (
    ...
    for message in _pm_me_mentioned_thread_messages:
        content = generate_first_line.get(message.thread_message_body[0])

        pm_me_mentioned_thread_messages.append(
            {
    ...
    return pm_me_mentioned_thread_messages
