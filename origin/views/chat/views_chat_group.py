...
from origin.serializers.common.user_serializers import (
    ChatGroupSerializer,
    ChatGroupMemberSerializer,
)
from origin.models.common.user_models import ChatGroup, ChatGroupMember
...
def join_chat_group(request):
    ...
    if "st_chat_group_name" not in data:
        return Response(
            {"message": "Missing field: 'st_chat_group_name'"}, status=status.HTTP_400_BAD_REQUEST
        )
